...
public class DAOUtilisateur {
        ...
        public Utilisateur trouverParId(int id) {
            ...
            try {
                ...
                if (result.next()) {
                    utilisateur = new Utilisateur(result.getInt("id_utilisateur"), result.getString("nom"), result.getString("prenom"), result.getString("login"), result.getString("mdp"));
                }
            } catch (SQLException e) {
                e.printStackTrace();
            }
    ...
    public Utilisateur authentifier(String login, int mdp) throws DAOException {
        try {
            ...
            if (resultSet.next()) {
                ...
                Utilisateur utilisateur = new Utilisateur(idUtilisateur, nom, prenom, loginBdd, mdpBdd);
                return utilisateur;
            } else {
                return null;
            }
